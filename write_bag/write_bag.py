...
######## config #######
BAG_NAME = r'autoware-20190828191451'
BAG_PATH_OLD = r'/media/cyrus/Elements/Research/self-driving/Anonymizer/bags/' + BAG_NAME + '.bag'
BAG_PATH_NEW = r'/media/cyrus/Elements/Research/self-driving/Anonymizer/bags/' + BAG_NAME + '_blur.bag'
PIC_PATH_BLURRED = r'/media/cyrus/Elements/Research/self-driving/Anonymizer/bags/' + BAG_NAME + '_blur'
#######################
	...
	with tqdm(total=num) as pbar:
		for topic, msg, t in inbag.read_messages():
			if topic == '/camera_array/cam0/image_raw/compressed':
				...
				img_msg = br.cv2_to_compressed_imgmsg(cv_img, dst_format='jpg')
