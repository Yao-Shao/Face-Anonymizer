...
filepath=r'/media/cyrus/Elements/Research/self-driving/Anonymizer/bags/autoware-20190828191451.bag'
...
def bag2image(topic_name,output_dir,num):
	with tqdm(total=num) as pbar:
		...
		count=0
		timestamp=[]
		for _topic, msg, t in bag.read_messages(topics=topic_name):
...
num=bag.get_message_count('/rslidar_points')
...
lidar_list={'lidar':lidar_timestamp}
